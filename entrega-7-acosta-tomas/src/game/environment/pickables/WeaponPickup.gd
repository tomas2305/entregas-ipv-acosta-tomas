...
onready var weapon_tutorial_pivot: Node2D = $WeaponTutorialPivot
...
func _ready() -> void:
	...
	if weapon.weapon_tutorial != null:
		weapon_tutorial_pivot.add_child(weapon.weapon_tutorial.instance())
